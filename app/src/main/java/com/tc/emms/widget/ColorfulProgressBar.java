...
public class ColorfulProgressBar extends View {  
    ...
    public ColorfulProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {  
        ...
        mReachedColor = typedArray.getColor(R.styleable.ColorfulProgressBar_reachedColor, Color.parseColor("#39b7ff"));  
        mUnReachedColor = typedArray.getColor(R.styleable.ColorfulProgressBar_unReachedColor, Color.rgb(204, 204, 204));  
        mReachedHight = typedArray.getDimension(R.styleable.ColorfulProgressBar_reachedHight, DeviceUtils.dp2px(context, 3.5f));  
        mUnReachedHight = typedArray.getDimension(R.styleable.ColorfulProgressBar_unReachedHight, DeviceUtils.dp2px(context, 2.5f));  
        mProgressTextOffset = typedArray.getDimension(R.styleable.ColorfulProgressBar_progressTextOffset, DeviceUtils.dp2px(context, 3.0f));  
        mProgressTextSize = typedArray.getDimension(R.styleable.ColorfulProgressBar_progressTextSize, DeviceUtils.sp2px(context, 14.0f));  
    ...
    private void drawText(Canvas canvas) {  
        ...
        int y =  hight/2 + (rect.bottom - rect.top)/2 + 15;  
